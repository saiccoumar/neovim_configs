...
local logo = {
[[                           _____                                                                             ]],
[[            _____     _____\    \       ____    _______    ______   ____________         ___________         ]],
[[       _____\    \   /    / |    |  ____\_  \__ \      |  |      | /            \       /           \        ]],
[[      /    / \    | /    /  /___/| /     /     \ |     /  /     /||\___/\  \\___/|     /    _   _    \       ]],
[[     |    |  /___/||    |__ |___|//     /\      ||\    \  \    |/  \|____\  \___|/    /    //   \\    \      ]],
[[  ____\    \ |   |||       \     |     |  |     |\ \    \ |    |         |  |        /    //     \\    \     ]],
...
[[|    |/ \    \     |\    \  /  \ |     | /     /|  |\         /|   /  \/   /_/  |  /       \ ___ /       \   ]],
[[|\____\ /____/|    | \____\/    ||\     \_____/ |  | \_______/ |  |____________/| /________/|   |\________\  ]],
[[| |   ||    | |    | |    |____/|| \_____\   | /    \ |     | /   |           | /|        | |   | |        | ]],
[[ \|___||____|/      \|____|   | | \ |    |___|/      \|_____|/    |___________|/ |________|/     \|________| ]],
[[                          |___|/   \|____|                                                                   ]],
                          "",
  os.date("[ %m/%d/%y + %H:%M:%S ]"),
}
...
local render = function()
  ...
  vim.opt_local.filetype       = "SaisDashboard"
...
Dashboard.setup = function()
  ...
  vim.api.nvim_create_autocmd("VimResized", {
    callback = function()
      if vim.bo.filetype == "SaisDashboard" then
        vim.opt_local.modifiable = true
